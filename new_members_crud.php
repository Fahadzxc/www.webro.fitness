...
if (isset($_GET['delete'])) {
    ...
    header("Location: new_members_crud.php");
    exit();
}
...
// Get all new invoices for the current month
  ...
  <div class="row">
    ...
    <div class="col-md-10 content-area">
      <div class="page-header d-flex justify-content-between align-items-center">
        <div>
          <h1><i class="fas fa-user-plus text-primary me-2"></i> New Members (<?php echo date('F Y'); ?>)</h1>
          <p class="text-muted">Manage new members for the current month</p>
        </div>
      ...
      <div class="card card-box">
        <div class="card-header bg-primary text-white">
          <i class="fas fa-list me-2"></i> New Members List
        </div>
        <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="action-buttons">
                    ...
                    <a href="new_members_crud.php?unpaid=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm" onclick="return confirm('Are you sure you want to mark this invoice as unpaid?');">
                      <i class="fas fa-times-circle me-1"></i> Mark as Unpaid
                    </a>
                    <a href="new_members_crud.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this invoice? This action cannot be undone.');">
          ...
          <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i> No new invoices found for the current month.
          </div>
          <?php endif; ?>
        </div>
      </div>
