...
// Fetch user-specific data using prepared statements
      ...
      <div class="row mb-4">
        <div class="col-md-8">
          <div class="card card-box">
            ...
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item">Name: <strong><?php echo htmlspecialchars($user_data['firstName'] . ' ' . $user_data['lastName']); ?></strong></li>
                <li class="list-group-item">Email: <strong><?php echo htmlspecialchars($user_data['email']); ?></strong></li>
                <li class="list-group-item">Role: <strong><?php echo htmlspecialchars($user_data['role']); ?></strong></li>
              </ul>
            </div>
          </div>
        </div>
